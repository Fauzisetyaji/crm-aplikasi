    ...
    <div class="fullwidth-block content">
        <div class="container">
            ...
            <div class="team image-left">
                <figure class="team-image"><img src="{{ asset('frontend-assets/dummy/person-1.jpg') }}" alt="person-1"></figure>
            ...
            <div class="team image-left">
                <figure class="team-image"><img src="{{ asset('frontend-assets/dummy/person-2.jpg') }}" alt="person-2"></figure>
            ...
            <div class="team image-left">
                <figure class="team-image"><img src="{{ asset('frontend-assets/dummy/person-3.jpg') }}" alt="person-3"></figure>
            ...
            <div class="team image-left">
                <figure class="team-image"><img src="{{ asset('frontend-assets/dummy/person-4.jpg') }}" alt="person-4"></figure>
