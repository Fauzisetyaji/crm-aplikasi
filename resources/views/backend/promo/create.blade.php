...
@section('title', 'Entry Promo Pelanggan')
...
<div class="col-md-9">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form role="form" action="{{ route('promo.store') }}" method="post" class="form-horizontal">
                {{ csrf_field() }}
                    ...
                    <div class="col-md-4">
                        <select
                            ...
                            @foreach($pelanggans as $key => $item)
                                <option {{ old('pelanggan_id') == $item->id ? "selected" : "" }} value="{{ $item->id }}">{{ $item->nm_pelanggan }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
