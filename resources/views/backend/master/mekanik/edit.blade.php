        ...
        <div class="panel-body">
            <form role="form" action="{{ route('mekanik.update', $mekanik->id) }}" method="post" class="form-horizontal">
                ...
                <div class="form-group{{ $errors->has('nm_mekanik') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="nm_mekanik" class="form-control" value="{{ old('nm_mekanik', $mekanik->nm_mekanik) }}" placeholder="X-50-X" required>
                ...
                <div class="form-group{{ $errors->has('alamat') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        <textarea class="form-control" name="alamat" required>{{ old('alamat', $mekanik->alamat) }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group{{ $errors->has('no_telp') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="no_tlp" value="{{ old('no_tlp', $mekanik->no_tlp) }}" class="form-control" required>
                    </div>
                </div>
