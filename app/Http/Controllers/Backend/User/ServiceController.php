...
class ServiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend-user.service.index', [ 'list' => $list ]);
    }
    ...
    {
        return view('backend-user.service.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('backend-user.service.show', ['service' => $service]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend-user.service.edit', ['service' => $service]);
    }
